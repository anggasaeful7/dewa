                                    ...
                                    <tbody>
                                        @forelse ($predictions as $prediction)
                                            @php
                                                ...
                                                $kondisiItem = $kondisi->firstWhere(
                                                    'id_penduduk',
                                                    $prediction['id_penduduk'],
                                                );
                                            @endphp
                                            <tr>
                                                <td>
                                                    <img src="{{ asset('storage/pas_foto/' . $prediction['pas_foto']) }}"
                                                ...
                                                <td>
                                                    {{-- Pakai image --}}
                                                    @if ($kondisiItem)
                                                        <img src="{{ asset('storage/foto_rumah/' . $kondisiItem->foto_rumah) }}"
                                                            alt="" style="width: 100px">
                                                    @else
