            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Pendidikan</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Pendidikan</h6>
                </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h6>Tambah Data Pendidikan</h6>
                            <a href="{{ route('rw.pendidikan.index') }}" class="btn btn-primary">Kembali</a>
                        </div>

                        <div class="card-body px-0 pt-0 pb-2">
                            <form role="form" class="form-group mx-10 my-6"
                                action="{{ route('rw.pendidikan.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    <input type="hidden" id="Penghasilan" name="Nama" class="form-control"
